...
public class SubscriberController {
  ...
  public DataResult<String> doAddSubscriber(@RequestBody ApplyInfoDTO applyInfo) {
  ...
  public DataResult<String> insertChat(@RequestParam("roundSerialNo") String roundSerialNo,
    ...
    return subscriberService.insertChat(roundSerialNo, memberID, chatContents, regDate);
  }
   ...
   * @return
   */
  @RequestMapping("/getNewChatMassage")
  @ResponseBody
  public DataResult<List> getNewChatMassage(@RequestParam("memberId") String memberId) {
    return subscriberService.getNewChatMassage(memberId);
  }
